...
//#define PRIORITY_OSA_TO_RTOS(osa_prio)  ((int)K_HIGHEST_THREAD_PRIO - (osa_prio) + 2U)
//#define PRIORITY_RTOS_TO_OSA(rtos_prio) ((int)K_HIGHEST_THREAD_PRIO - (rtos_prio) + 2U)
